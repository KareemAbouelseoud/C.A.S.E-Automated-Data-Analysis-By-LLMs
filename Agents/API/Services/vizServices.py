...
class vizService:
    ...
    async def createVisualizations(self,data_report,project_id,features=None):
        visualizations = await pipeline.generate_visualizations(data_report,project_id,features)
