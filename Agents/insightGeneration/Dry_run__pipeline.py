...
graph_builder.add_node("filteration_node_A", filterationA_node)
graph_builder.add_node("filteration_node_B", filterationB_node)
...
graph_builder.add_conditional_edges("qugen_node", should_continue, {"qugen_node": "qugen_node", "filteration_node_A": "filteration_node_A"})
graph_builder.add_edge("filteration_node_A", "SubSbaceSearch_Node")
